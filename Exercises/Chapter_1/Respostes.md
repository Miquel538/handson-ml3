**1.- Como definirias el machine Learning?**
...
**2.-¿Puedes nombrar 4 tipo de aplicaciones en las que destaca?**
...
**3.- ¿Que es un conjunto de entrenamiento etiquetado?**
...
**4.-¿Cuales son las dos tareas supervisadas mas comunes?**

las tareas mas típicas són : La clasificación y la regresión.


**5.-¿Puedes nombrar 4 tareas no supervisadas comunes?**
    - agrupación
    - visualización, 
...
**6.-¿Qué tipo de algoritmo utilizarias para permitir a un robot caminar por varios terrenos desconocidos?**

Usaría un algoritmo de aprendizaje por refuerzo.


**7.- ¿Definirías el problema de detección de spam como un problema de aprendizaje supervisado o no supervisado?**
...
**8.-¿Que es un sistema de aprendizaje online?**
...
**9.-¿Que es el aprendizaje out of core?**
...
**10.-¿Que tipo de algoritmo depende de una medida de similitud para hacer predicciones?**
...
**11.-¿Cual es la diferencia entre un parametro de modelo y un hiperparametro de modelo?**
...
**12.-¿Qué buscan los algoritmos basados en modelos? ¿Cuál es la estrategia mas comun que usan para tener exito? ¿Cómo hacen predicciones?**
...
**13.-¿Puedes nombrar cuatro de los principales retos del machine learning?**
...
**14.- Si tu modelo tiene un gran rendimiento en los datos de entrenamiento, pero generaliza mal a instancias nuevas, ¿Qué esta pasando? ¿Puedes nombrar 3 soluciones possibles?**
...
**15.- ¿Que es un conjunto de prueba y por qué te convendría usarlo?**
...
**16.-¿Cual es el objetivo de un conjunto de validación?**
...
**17.- ¿Qué es el conjunto de entrenamiento-desarrollo, cuándo es necesario y como se utiliza?**
...
**18.-¿Que puede salir mal si ajustamos hiperparámetros utilizando el conjunto de prueba?**
